...
public class MileageCalculatorNoConversion extends Application {
	...
	private ObservableList<String> choices = FXCollections.observableArrayList(defaultResult, altResult);
	private ComboBox<String> cbo = new ComboBox<>(choices);
	...
	public void start(Stage primaryStage) {
		...
		// set toggle group for RadioButtons4
